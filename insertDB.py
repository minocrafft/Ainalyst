...
def main():
    ...
    for idx, (
        ...
        ainalyst.execute(
            f"INSERT INTO home_report(create_date, company, title, article, opinion, new_opinion, firm, pred_rate)"
            f" VALUES(%s, %s, %s, %s, %s, %s, %s, %s);",
            (date, company, title, article, opinion, predictions, firm, pred_rate),
        )
